    ...
    <div class="container">
        ...
        <form name="formtmkonten" id="formtmkonten" method="post" action="<?php echo base_url('materi/doTambahKonten') ?>" enctype="multipart/form-data" class="form-group" role="form">
                ...
                <div class="col-lg-11 col-md-10 col-sm-9 col-xs-12">
                    <select name="kategori" class="form-control" id="kategori">
                        <?php
                            $selectclass = '';
                            $selectlab = '';
                            if($konten['tipe'] == 'class'){
                                $selectclass = 'selected';
                            } else if($konten['tipe'] == 'lab'){
                                $selectlab = 'selected';
                            }
                        ?>
                        <option value="class" <?php echo $selectclass; ?>>Class Activity</option>
                        <option value="lab"  <?php echo $selectlab; ?>>Lab Activity</option>
                    </select>
            ...
            <div class="row item-reg">
                ...
                <div class="col-lg-11 col-md-10 col-sm-9 col-xs-12">
                    <input type="hidden" name="materitemp" value="<?php echo $konten['isi']; ?>">
                    <?php
                        $tipekonten = substr($konten['isi'],0,3);
                        $filename = "http://localhost:8080/e-learning/upload/materi/".$konten['isi'];
                        if($tipekonten == "pdf"){       
                            ?>
                            <iframe src="http://localhost:8080/e-learning/assets/js/pdfjs/web/viewer.html?file=<?php echo $filename?>#zoom=page-auto"></iframe>
                            <br/>
                        <?php
                        }
                        ...
                        ?>
                            ...
                            <textarea name="isimateri" id="isimateri" rows="20">
                                <?php 
                                    echo ($tipekonten != 'pdf' && $tipekonten != 'vid') ? $konten['isi'] : '' ;
                                    echo $konten['tambahan'];
                                ?>
                            </textarea>
            ...
            <div class="col-lg-offset-1 col-md-offset-2">
                ...
                <button href="<?php echo base_url('materi');?>" class="btn btn-default">Batal</button>
            </div>
        </form>
        <?php } ?>
    </div>
